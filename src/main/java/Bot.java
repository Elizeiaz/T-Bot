...
//        String searchUrl = "https://newyork.craigslist.org/search/sss?sort=rel&query=iphone+6s";
        webParser.grepHtmlByClass(webParser.getHtmlXml(searchUrl), "//a[@class='itemlink']");
//        webParser.grepHtmlByClass(webParser.getHtmlXml(searchUrl), "//span[@class='pictag']");
